...
import "../styles/TeacherSidebar.css"; // Ensure your CSS path is correct
...
const TeacherSidebar = () => {
  ...
  const handleLogout = () => {
    ...
    navigate("/employeelogin");  // Redirect to login page using React Router's navigate
  };
  ...
  return (
    <div className="sidebar">
      ...
      {/* Dashboard Link */}
      <NavLink to="/dashboard/teacher" className={({ isActive }) => (isActive ? "active" : "")}>
        <FaHome className="sidebar-icon" /> Dashboard
      </NavLink>

      {/* Bookings Link */}
      <NavLink to="/bookings/teacher" className={({ isActive }) => (isActive ? "active" : "")}>
      ...
      {/* Profile Link */}
      <NavLink to="/profile/teacher" className={({ isActive }) => (isActive ? "active" : "")}>
